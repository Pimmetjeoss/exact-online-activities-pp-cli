...
<<<<<<< HEAD
	...
	ExactOnlineActivitiesOauth2 string          `toml:"online_activities_oauth2"`
=======
	TokenURL                    string `toml:"token_url,omitempty"`
	Path                        string `toml:"-"`
	ExactOnlineActivitiesOauth2 string `toml:"online_activities_oauth2"`
...
=======
	path := configPath
	if path == "" {
		path = os.Getenv("EXACT_ONLINE_ACTIVITIES_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "exact-online-activities-pp-cli", "config.toml")
	}
	cfg.Path = path
...
>>>>>>> origin/main
	...
	// Env var overrides
	if v := os.Getenv("EXACT_ONLINE_ACTIVITIES_OAUTH2"); v != "" {
		cfg.ExactOnlineActivitiesOauth2 = v
<<<<<<< HEAD
		cfg.markEnvOverride("ExactOnlineActivitiesOauth2")
		cfg.AuthSource = "env:EXACT_ONLINE_ACTIVITIES_OAUTH2"
		cfg.CredentialSource = "env:EXACT_ONLINE_ACTIVITIES_OAUTH2"
	}
=======
		cfg.AuthSource = "env:EXACT_ONLINE_ACTIVITIES_OAUTH2"
	}
...
=======
	...
	if cfg.AuthSource == "" && cfg.ExactOnlineActivitiesOauth2 != "" {
		cfg.AuthSource = "config"
>>>>>>> origin/main
	}

	// Base URL override (used by printing-press verify to point at mock/test servers)
	if v := os.Getenv("EXACT_ONLINE_ACTIVITIES_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("EXACT_ONLINE_ACTIVITIES_AUTHORIZATION_URL"); v != "" {
		cfg.AuthorizationURL = v
	}
	if v := os.Getenv("EXACT_ONLINE_ACTIVITIES_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("EXACT_ONLINE_ACTIVITIES_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "exact-online-activities-pp-cli", "config.toml"), nil
}
...
<<<<<<< HEAD
	...
	// A directly-held bearer in EXACT_ONLINE_ACTIVITIES_OAUTH2 (a pasted access token, or a
	...
	if c.ExactOnlineActivitiesOauth2 != "" {
		return "Bearer " + c.ExactOnlineActivitiesOauth2
	}
	return ""
}
...
func (c *Config) StoreScopeCredential() string {
	...
	if c.ExactOnlineActivitiesOauth2 != "" {
		parts = append(parts, "online_activities_oauth2="+c.ExactOnlineActivitiesOauth2)
	}
	if len(parts) == 0 {
		return ""
	}
...
=======
	...
	if c.ExactOnlineActivitiesOauth2 != "" {
		c.AuthSource = "env:EXACT_ONLINE_ACTIVITIES_OAUTH2"
		return "Bearer " + c.ExactOnlineActivitiesOauth2
	}
	if c.AccessToken != "" {
		c.AuthSource = "oauth2"
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ExactOnlineActivitiesOauth2: c.ExactOnlineActivitiesOauth2,
	}
}
...
func (c *Config) applyCredentials(creds *cliutil.Credentials) {
	...
	if c.ExactOnlineActivitiesOauth2 == "" {
		c.ExactOnlineActivitiesOauth2 = creds.ExactOnlineActivitiesOauth2
	}
}
...
<<<<<<< HEAD
	...
	c.updateFileConfigField("ClientSecret")
	c.ExactOnlineActivitiesOauth2 = ""
	delete(c.envOverrides, "ExactOnlineActivitiesOauth2")
	c.updateFileConfigField("ExactOnlineActivitiesOauth2")
	if c.AgentcookieManagedByExternalStore() {
		c.markAgentcookieManaged()
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ExactOnlineActivitiesOauth2"] {
			out.ExactOnlineActivitiesOauth2 = c.fileConfig.ExactOnlineActivitiesOauth2
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ExactOnlineActivitiesOauth2":
		c.fileConfig.ExactOnlineActivitiesOauth2 = c.ExactOnlineActivitiesOauth2
	}
}
