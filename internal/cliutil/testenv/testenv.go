...
var clearedVars = []string{
	"EXACT_ONLINE_ACTIVITIES_CONFIG",
	"EXACT_ONLINE_ACTIVITIES_CONFIG_DIR",
	"EXACT_ONLINE_ACTIVITIES_DATA_DIR",
	"EXACT_ONLINE_ACTIVITIES_STATE_DIR",
	"EXACT_ONLINE_ACTIVITIES_CACHE_DIR",
	"EXACT_ONLINE_ACTIVITIES_HOME",
	"XDG_CONFIG_HOME",
	"XDG_DATA_HOME",
	"XDG_STATE_HOME",
	"XDG_CACHE_HOME",
