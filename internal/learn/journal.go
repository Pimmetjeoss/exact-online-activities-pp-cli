...
const (
	journalSessionEnvVar   = "EXACT_ONLINE_ACTIVITIES_LEARN_SESSION"
	journalNoLearnEnvVar   = "EXACT_ONLINE_ACTIVITIES_NO_LEARN"
	journalNoCaptureEnvVar = "EXACT_ONLINE_ACTIVITIES_LEARN_NO_CAPTURE"
)
