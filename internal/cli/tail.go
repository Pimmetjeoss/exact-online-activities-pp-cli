...
native streaming instead of polling.`,
  ...
  exact-online-activities-pp-cli tail --interval 10s

  # Tail a specific resource
  exact-online-activities-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  exact-online-activities-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
