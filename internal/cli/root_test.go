...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"activities",
		"activities annual-statements-get",
		"activities annual-statements-post",
		"activities annual-statements-put",
		"activities communication-notes-get",
		"activities communication-notes-post",
		"activities complaints-get",
		"activities complaints-post",
		"activities events-get",
		"activities events-post",
		"activities fiscals-get",
		"activities fiscals-post",
		"activities fiscals-put",
		"activities service-requests-get",
		"activities service-requests-post",
		"activities tasks-get",
		"activities tasks-post",
	}
