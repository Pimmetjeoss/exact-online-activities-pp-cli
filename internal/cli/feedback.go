...
=======
	...
	dir := filepath.Join(home, ".exact-online-activities-pp-cli")
	if err := os.MkdirAll(dir, 0o700); err != nil {
...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("EXACT_ONLINE_ACTIVITIES_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("EXACT_ONLINE_ACTIVITIES_FEEDBACK_AUTO_SEND")))
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "exact-online-activities-pp-cli/feedback")
...
=======
		Long: `Feedback is captured locally first at ~/.exact-online-activities-pp-cli/feedback.jsonl.
>>>>>>> origin/main
When ` + "`EXACT_ONLINE_ACTIVITIES_FEEDBACK_ENDPOINT`" + ` is set and either --send is
passed or ` + "`EXACT_ONLINE_ACTIVITIES_FEEDBACK_AUTO_SEND=true`" + `, the entry is
...
maintainer sees it.`,
<<<<<<< HEAD
		Example: `  exact-online-activities-pp-cli feedback "the --since flag is inclusive but docs say exclusive"
  exact-online-activities-pp-cli feedback --stdin < notes.txt
  exact-online-activities-pp-cli feedback list --limit 10`,
=======
>>>>>>> origin/main
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			entry := FeedbackEntry{
				Text:      text,
				CLI:       "exact-online-activities-pp-cli",
				Version:   version,
...
=======
>>>>>>> origin/main
		Example: `  exact-online-activities-pp-cli feedback list
  exact-online-activities-pp-cli feedback list --limit 5
  exact-online-activities-pp-cli feedback list --json`,
