...
but do not stop the import.`,
  ...
  exact-online-activities-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  exact-online-activities-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | exact-online-activities-pp-cli import <resource> --input -`,
