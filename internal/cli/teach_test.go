...
import (
	...
	"exact-online-activities-pp-cli/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"exact-online-activities-pp-cli auth login",
		"exact-online-activities-pp-cli doctor",
		"exact-online-activities-pp-cli help items",
		"exact-online-activities-pp-cli sync",
		"exact-online-activities-pp-cli profile list",
		"exact-online-activities-pp-cli feedback list",
		"exact-online-activities-pp-cli which",
		"exact-online-activities-pp-cli agent-context",
		"exact-online-activities-pp-cli completion bash",
		"exact-online-activities-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"exact-online-activities-pp-cli recall",
		"exact-online-activities-pp-cli learnings",
		"exact-online-activities-pp-cli teach-pattern",
		"exact-online-activities-pp-cli teach-lookup",
		"exact-online-activities-pp-cli items list",
	}
