...
import (
	...
	mcptools "exact-online-activities-pp-cli/internal/mcp"
...
func main() {
	...
	_ = os.Setenv("EXACT_ONLINE_ACTIVITIES_LEARN_SURFACE", "mcp")
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "exact-online-activities-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
